...
public class Utils {
    ...
    public static String[] getSootArgs(String analysisToRun, String classToAnalyze) {
        System.out.println("Analysis: " + analysisToRun);
        System.out.println("Class: " + classToAnalyze);
        ...
        String [] args = {"-cp", sootClasspath, "-keep-line-number", "-f", "S", "-p", analysisToRun, "on", classToAnalyze };
        return args;
    }
